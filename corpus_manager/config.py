...
# Use RAG_CORPUS (full path) if available, otherwise fall back to RAG_CORPUS_NAME
RAG_CORPUS_NAME = os.environ.get("RAG_CORPUS") or os.environ.get("RAG_CORPUS_NAME")
...
def validate_config():
    ...
    required_vars = [
        ...
        ("RAG_CORPUS or RAG_CORPUS_NAME", RAG_CORPUS_NAME)
    ]
